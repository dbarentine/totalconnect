 ...
 *         &lt;element name="UserDetails" type="{https://services.alarmnet.com/TC2/}UserDetailsEx" minOccurs="0"/>
...
@XmlRootElement(name = "SaveUserEx")
public class SaveUserEx {

    @XmlElement(name = "SessionID")
    protected String sessionID;
    @XmlElement(name = "UserDetails")
    protected UserDetailsEx userDetails;
     ...
     *     
     */
    public UserDetailsEx getUserDetails() {
        return userDetails;
    }
     ...
     *     
     */
    public void setUserDetails(UserDetailsEx value) {
