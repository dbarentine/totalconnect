 ...
 *         &lt;element name="Partitions" type="{https://services.alarmnet.com/TC2/}ArrayOfInt" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DisarmSecuritySystemPartitions")
public class DisarmSecuritySystemPartitions {
    ...
    protected ArrayOfInt partitions;
     ...
     *     
     */
    public ArrayOfInt getPartitions() {
        return partitions;
    }
     ...
     *     
     */
    public void setPartitions(ArrayOfInt value) {
