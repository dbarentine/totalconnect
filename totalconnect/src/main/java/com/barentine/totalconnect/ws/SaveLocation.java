 ...
 *         &lt;element name="Locale" type="{https://services.alarmnet.com/TC2/}LocationInfo" minOccurs="0"/>
...
@XmlRootElement(name = "SaveLocation")
public class SaveLocation {

    @XmlElement(name = "SessionId")
    protected String sessionId;
    @XmlElement(name = "Locale")
    protected LocationInfo locale;
     ...
     *     
     */
    public void setLocale(LocationInfo value) {
        this.locale = value;
    }
